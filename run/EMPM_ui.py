...
outputfile7.write('$MPIRUN_PATH/mpirun -np $NUM_MPI_PROCS ./phon_dens1_MPI > log_dens1 2>error_phon_dens1\n')
outputfile7.close()
...
outputfile11.write('#$MPIRUN_PATH/mpirun -np $NUM_MPI_PROCS ./phon_int_MPI > log_phon_int 2>error_phon_int    \n')
